...
-->
  ...
  <xsl:variable name="np_conj.L1.op-index-S.NUM.CASE.distr">
    <atomcat type="np_conj">
      <fs>
        <feat attr="num"><featvar name="NUM:num-vals"/></feat>
        <feat attr="case"><featvar name="CASE"/></feat>
  ...
  <xsl:variable name="np_conj.1.L2.op-index-S">
    <atomcat type="np_conj">
      <fs id="1">
...
<!--  <xsl:variable name="bt.LH">
  ...
  <xsl:variable name="s.1.E.dcl.active.default">
    <atomcat type="s">
      <fs id="1">
        <feat attr="num"><featvar name="NUM:num-vals"/></feat>
        <feat attr="pers"><featvar name="PERS:pers-vals"/></feat>
  ...
  <xsl:variable name="s.1.E.dcl.passive.default">
    <atomcat type="s">
      <fs id="1">
        <feat attr="num"><featvar name="NUM:num-vals"/></feat>
        <feat attr="pers"><featvar name="PERS:pers-vals"/></feat>
  ...
  <xsl:variable name="s.from-1.E1.NUM.PERS.CASE.VOICE">
    <atomcat type="s">
      <fs inheritsFrom="1">
        <feat attr="num"><featvar name="NUM:num-vals"/></feat>
        <feat attr="pers"><featvar name="PERS:pers-vals"/></feat>
        <feat attr="case"><featvar name="CASE"/></feat>
        <feat attr="voice"><featvar name="VOICE"/></feat>
        <feat attr="index"><lf><nomvar name="E1"/></lf></feat>
      </fs>
    </atomcat>
  </xsl:variable>
