...
$Revision: 1.22 $, $Date: 2005/07/22 20:44:23 $ 
...
<xsl:transform 
  ...
  <!-- Relative Pronoun -->
  <entry stem="that" pos="RelPro" macros="@X-thing">
<!--    <member-of family="RelPro" entry="Primary"/>-->
...
<!--    <member-of family="Subconj-Initial-Only"/>
  ...
  <entry stem="when" pos="WhNP" macros="@X-time">
    <member-of family="WhNP"/>
  </entry>

  <!-- Simple determiners -->
  <entry stem="indef" pos="Det">
    <member-of family="Det"/>
    <word form="a" macros="@sg-2"/>
    <word form="an" macros="@sg-2"/>
    <word form="some" macros="@pl-2"/>
  </entry>

  <entry stem="def" pos="Det" class="the">
    <member-of family="Det"/>
    <word form="the"/>
  </entry>

  <!-- Predicational determiners -->
  <entry stem="another" pos="Det" macros="@sg-2">
    <member-of family="Det"/>
  </entry>
  <entry stem="dem-prox" pos="Det">
    <member-of family="Det"/>
    <word form="this" macros="@sg-or-mass-2"/>
    <word form="these" macros="@pl-2"/>
  </entry>
  <entry stem="dem-nonprox" pos="Det">
    <member-of family="Det"/>
  ...
  <entry stem="be-verb" pos="V">
    ...
    <word form="am" macros="@pres @active @sg-agr @1st-agr"/>
    <word form="are" macros="@pres @active @sg-agr @2nd-agr"/>
    <word form="is" macros="@pres @active @sg-or-mass-agr @3rd-agr"/>
    <word form="are" macros="@pres @active @pl-agr"/>
    <word form="was" macros="@past @active @sg-agr @1st-agr"/>
    <word form="were" macros="@past @active @sg-agr @2nd-agr"/>
    <word form="was" macros="@past @active @sg-or-mass-agr @3rd-agr"/>
    <word form="were" macros="@past @active @pl-agr"/>
  </entry>

  <!-- Have (aux use tbd) -->
  <entry stem="have-verb" pos="V">
    <member-of family="TransitiveVerbs"/>
    <word form="have" macros="@base" excluded="Inverted"/>
    <word form="have" macros="@pres @active @sg-agr @non-3rd-agr"/>
    <word form="has" macros="@pres @active @sg-or-mass-agr @3rd-agr"/>
    <word form="have" macros="@pres @active @pl-agr"/>
    <word form="had" macros=" @active @past"/>
  </entry>
...
<!--  <entry stem="like" pos="V">
  ...
  <entry stem="mention" pos="V">
    ...
    <word form="mention" macros="@pres @active @sg-agr @non-3rd-agr"/>
    <word form="mentions" macros="@pres @active @sg-or-mass-agr @3rd-agr"/>
    <word form="mention" macros="@pres @active @pl-agr"/>
    <word form="mentioned" macros="@past @active"/>
    <word form="mentioned" macros="@ppart"/>
  </entry>

  <!-- Say -->
  <entry stem="say" pos="V">
    <member-of family="Statement"/>
    <word form="say" macros="@pres @active @sg-agr @non-3rd-agr"/>
    <word form="says" macros="@pres @active @sg-or-mass-agr @3rd-agr"/>
    <word form="say" macros="@pres @active @pl-agr"/>
    <word form="said" macros="@past @active"/>
    <word form="said" macros="@ppart"/>
  </entry>
  ...
  <macro name="@ppart">
    <fs id="1" attr="form" val="ppart"/>
    <lf>
      <satop nomvar="E">
        <diamond mode="voice"><prop name="passive"/></diamond>
      </satop>
    </lf>
  </macro>
...
<!--  <macro name="@ppart">
  ...
  <macro name="@X-time">
    <fs id="2">
      <feat attr="index"><lf><nomvar name="X:time"/></lf></feat> 
    </fs>
  </macro>
  ...
  <macro name="@X-thing">
    <fs id="2">
      <feat attr="index"><lf><nomvar name="X:inanimate"/></lf></feat> 
    </fs>
  </macro>
  ...
  <macro name="@active">
    <lf>
      <satop nomvar="E">
        <diamond mode="voice"><prop name="active"/></diamond>
      </satop>
    </lf>
  </macro>
